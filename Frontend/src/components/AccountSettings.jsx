  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        ...
        setUserData({
          displayName: `${userDataFromBackend.firstName} ${userDataFromBackend.lastName}`,
          email: userDataFromBackend.email || '',
          phoneNumber: userDataFromBackend.phoneNumber || '',
          address: userDataFromBackend.address?.street || '',
          city: userDataFromBackend.address?.city || '',
          country: userDataFromBackend.address?.country || '',
          profileImage: userDataFromBackend.profileImage || '',
          emailNotifications: userDataFromBackend.emailNotifications || false,
          smsNotifications: userDataFromBackend.smsNotifications || false,
          twoFactorAuth: userDataFromBackend.twoFactorAuth || false,
        });
      } catch (error) {
